  ...
  <script type="text/javascript">
    $(document).ready(function(){
		$('#myModalAdd').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'post',
                url : baseUrl + 'Hasil_inputan/pindah_style_packing',
                data :  'rowid='+ rowid,
...
<script>
    $(function() {
        table__ = $('#tbl_hasil_output').DataTable({
            ...
            "aaSorting": [],
            "ajax": {
                "url": baseUrl + 'Datatables_hasil_inputan/hasil_inputan_output_packing',
                "type": "POST",
                "data": {},
            },
...
function update_qty(id) {
	$.ajax({
	  url: baseUrl + 'Hasil_inputan/update_data_detail_packing',    
      type: 'POST',
      data: {         
        qty : $('#qty_'+id).val(),
