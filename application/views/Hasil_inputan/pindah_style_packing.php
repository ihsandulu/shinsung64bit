...
<table id="tbl_hasil_output_hd" style="width: 100%;" class="table table-striped table-condensed nowrap">
    ...
    <tr>
        <td width="129"><?php echo $data_packing['TANGGAL_HASIL']; ?></td>
        <td width="57"><?php echo $data_packing['LINE']; ?></td>
        <td width="128"><?php echo $data_packing['KANAAN_PO']; ?></td>
        <td width="158"><?php echo $data_packing['STYLE_NO']; ?></td>
        <td width="225"><?php echo $data_packing['COLOR']; ?></td>
        <td width="176"><?php echo $data_packing['QTYGLOBAL']; ?></td>
        <td width="192"><?php echo $data_packing['DES']; ?></td>
        <td width="112">-</td>
        <td width="83"><?php echo $data_packing['QTY']; ?></td>
      </tr>
    <tbody>
    </tbody>
  </table>
...
function pindah_hasil_hd(id) {
	...
	if (result) {
		$.ajax({
			url: baseUrl + 'Hasil_inputan/confirm_pindah_style_packing',    
			type: 'POST',
			data: {
				id : id
            },
