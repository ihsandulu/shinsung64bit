...
<div class="row">
  ...
  <div class="col-md-1 col-sm-2 col-xs-2" style="border:0px solid #000; text-align:center;" <?php echo $hidden; ?>>
     <div style="border:2px solid <?php echo $warna_bg; ?>; background-color:<?php echo $warna?>; color:<?php echo $warna_tulisan; ?>; font-size:30px; width:120%; padding:10px;">
