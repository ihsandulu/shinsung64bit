  ...
  <script>
      ...
      function preview() {
          ...
          switch (pilih) {
              case "SUMMARYDR":
                  $.post("<?= base_url("Report_end_line/Summary_defect_rate_Action1"); ?>", {
                  ...
                  break;
              case "DAILYDR":
                  $.post("<?= base_url("Report_end_line/Daily_defect_rate_Action1"); ?>", {
                          tanggal_start: tanggal_start,
                          tanggal_end: tanggal_end
                      })
                      .done(function(data) {
              ...
              case "periode_top_5_per_line":
                  $.post("<?= base_url("Report_end_line/Report_defect_top_5_per_line_periode_action1"); ?>", {
                          tanggal_start: tanggal_start,
                          tanggal_end: tanggal_end,
                  ...
                  break;
              case "daily":
                  $.get("<?= base_url("Report_end_line/Report_daily_action1"); ?>", {
                          line_sewing: line_sewing,
                          tanggal: tanggal
                      })
                      .done(function(data) {
