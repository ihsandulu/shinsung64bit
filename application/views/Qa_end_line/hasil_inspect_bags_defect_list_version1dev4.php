...
<div class="alert alert-warning" id="success-alert-final-hd-ok">
  <button type="button" class="close" data-dismiss="alert">x</button>
  <strong> </strong> OUTPUT PACKING DITAMBAHKAN
</div>
</div>
  ...
  <div class="row">
    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 colomn_satu">
      ...
      <div id="detail_data">
        ...
        <div align="left"><i>#KJ / Style / Color / Size </i></div>
        <div align="left" class="isi"><b>#<?php  echo $schedule['KANAAN_PO']; ?> / <?php  echo $schedule['STYLE_NO']; ?> / <?php  echo $schedule['COLOR']; ?>  / <?php  echo $schedule['SIZE']; ?> </b></div>
      ...
      <!-- <button class="button btn-block" style="background-color:blue; width: 98%; height: 50px;" id="btn_back" onClick="start_back()">BACK</button> -->
        ...
        <button class="button" style="background-color:purple;" onClick="insert3('0')">0</button>
        <button class="button" style="background-color:purple;" onClick="insert3('1')">1</button>
        <button class="button" style="background-color:purple;" onClick="insert3('2')">2</button>
                        
        <button class="button" style="background-color:purple;" onClick="insert3('3')">3</button>
        <button class="button" style="background-color:purple;" onClick="insert3('4')">4</button>
        <button class="button" style="background-color:purple;" onClick="insert3('5')">5</button>
                        
        <button class="button" style="background-color:purple;" onClick="insert3('6')">6</button>
        <button class="button" style="background-color:purple;" onClick="insert3('7')">7</button>
        <button class="button" style="background-color:purple;" onClick="insert3('8')">8</button>
                        
        <button class="button" style="background-color:purple;" onClick="insert3('9')">9</button>
    ...
    <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 colomn_dua">
      <table class="table table-striped table-bordered" id="Table_summary" style="width:100%;">
        <tbody>
          <tr>
            <td onClick="refresh_qty_cek()" width="34%" style="text-align:center;"> OUTPUT QC : <font size="+4"><strong><div id="jml_ceck"></div></strong></font>
            </td>
      ...
      <div align="right">
      <font size="+1" >OUTPUT PACKING : </font><b> <span id="jml_qty" style="text-align:left; font-weight: bold; margin-right:10px; font-size:18px;" ></span></b>
...
function renderTable_total_output_perline(data , nama_tabel) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    rows += "<td><strong> IRONING</strong></td>";
    rows += "<td><strong> PACKING</strong></td>";
    rows += "</tr><thead>";
    rows += "<tr>";
    rows += "<td><strong>JAM 1</strong></td>";
    rows += "<td>" + data[i].JAM_1 + "</td>";
  rows += "<td>" + data[i].JAM_IRON_1 + "</td>";
  rows += "<td>" + data[i].JAM_PACK_1 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_2 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_2 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_2 + "</td>";
    
  rows += "</tr>";
  rows += "<tr>";
  rows += "<td><strong>JAM 3</strong></td>"
  rows += "<td>" + data[i].JAM_3 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_3 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_3 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_4 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_4 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_4 + "</td>";
    
  rows += "</tr>";
  rows += "<tr>";
  rows += "<td><strong>JAM 5</strong></td>"
  rows += "<td>" + data[i].JAM_5 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_5 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_5 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_6 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_6 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_6 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_7 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_7 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_7 + "</td>";
    
  rows += "</tr>";
  rows += "<tr>";
  rows += "<td><strong>JAM 8</strong></td>"
  rows += "<td>" + data[i].JAM_8 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_8 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_8 + "</td>";
    
  rows += "</tr>";
  rows += "<tr>";
  rows += "<td><strong>JAM 9</strong></td>"
  rows += "<td>" + data[i].JAM_9 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_9 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_9 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_10 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_10 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_10 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_11 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_11 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_11 + "</td>";
    
  rows += "</tr>";;
  rows += "<tr>"
  rows += "<td><strong>JAM 12</strong></td>"
  rows += "<td>" + data[i].JAM_12 + "</td>";  
  rows += "<td>" + data[i].JAM_IRON_12 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_12 + "</td>";
    
  rows += "</tr>";
  rows += "<tr>";
  rows += "<td><strong>JAM 13</strong></td>"
  rows += "<td>" + data[i].JAM_13 + "</td>";  
  rows += "<td>" + data[i].JAM_IRON_13 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_13 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_14 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_14 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_14 + "</td>";
  ...
  rows += "<td>" + data[i].JAM_15 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_15 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_15 + "</td>";
    
  rows += "</tr>";
  rows += "<tr>";
  rows += "<td><strong>JAM 16</strong></td>"
  rows += "<td>" + data[i].JAM_16 + "</td>";
    rows += "<td>" + data[i].JAM_IRON_16 + "</td>";
    rows += "<td>" + data[i].JAM_PACK_16 + "</td>";
    ...
    rows += "<td>" + data[i].TOTAL_AKHIR_PACKING + "</td>";
    rows += "<td>" + data[i].TOTAL_AKHIR_IRON + "</td>";
