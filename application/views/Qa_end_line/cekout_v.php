...
<style>
    ...
    #form_defect {
        margin: 60px 20px 0px 10px !important;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Quantity Good</h4>
                </div>
                <div class="modal-body">
                    <input type="number" class="textbox" id="textbox2">
                    <button class="button4 " style="background-color:darkgreen;" onClick="okeinspect2()">OK</button>
                    <script>
                        function okeinspect2() {
                            let nilai = $("#textbox2").val();
                            $.get("", {})
                                .done(function() {
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="overflow">
                    ...
                    <div class=" col-md-12 kumpulant m-0 p-0" id="kumpulanb">
                        ...
                        <!--  <div class="col-md-3 m-0 p-0">
                            <button class="button btn btn-success" style=" width: 96%; height: 185px;" id="btn_ok" onClick="bukamodal()">GOOD<br />COMBINED</button>
                            <script>
                                function bukamodal() {
                                    $("#modalok").modal();
                                }
                    ...
                    <div class="container_form p-0" id="form_defect">
                        ...
                        <button class="button3" style="background-color:blue;" onClick="insert1('0')">0</button>
                        <button class="button3" style="background-color:blue;" onClick="insert1('1')">1</button>
                        <button class="button3" style="background-color:blue;" onClick="insert1('2')">2</button>

                        <button class="button3" style="background-color:blue;" onClick="insert1('3')">3</button>
                        <button class="button3" style="background-color:blue;" onClick="insert1('4')">4</button>
                        <button class="button3" style="background-color:blue;" onClick="insert1('5')">5</button>

                        <button class="button3" style="background-color:blue;" onClick="insert1('6')">6</button>
                        <button class="button3" style="background-color:blue;" onClick="insert1('7')">7</button>
                        <button class="button3" style="background-color:blue;" onClick="insert1('8')">8</button>

                        <button class="button3" style="background-color:blue;" onClick="insert1('9')">9</button>

                        <button class="button4 " style="background-color:darkred;" id="btn_end" onClick="end_check()">END CHECK</button>
                        <button class="button4 " style="background-color:red" onClick="kosongkan1()">DEL</button>
                        <button class="button4 " style="background-color:darkgreen;" onClick="btndefect()">OK</button>

                    </div>
                    <div class="col-md-12 kumpulant m-0 p-0">
                        <div class="col-md-12 p5d"><span class="label label-danger p-2 col-md-12">Top 5 Defect This Week</span></div>
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 colomn_dua m-0 p-0">
                <div class="row  m-0">
                    <div onClick="call_refresh_all();total_output_perline();loading('outputqc2');" class="col-md-6">
                        <div class="row kangka" id="outputqc">
                            ...
                            <script>
                                function loading(a) {
                                    toast("Cukup 1 x Klik!<br/>Jangan Berulang-ulang!");
                                    loadingshow();
...
<script>
    ...
    function oke_inspect() {
        ...
        if (color == "") {
            toast("Color belum diisi!");
            loadinghide();
        } else if (size == "") {
            toast("Size belum diisi!");
            loadinghide();
        } else {
