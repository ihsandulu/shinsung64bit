      ...
      <table class="table table-striped table-bordered" id="Table_summary" style="width:100%;">
        <tbody>
          <tr>
            ...
            <td width="22%" style="text-align:center;"> QTY CHECK : <font size="+1"><strong><div id="jml_ceck"></div></strong></font></td>
            <td width="23%" style="text-align:center;"> SUM DEFECT : <font size="+1"><strong><div id="jml_defect"></div> </strong></font></td>
            <td width="23%" style="text-align:center;" id="button_status"> % DEFECT : <font size="+1"><strong><div id="jml_persen"></div> </strong></font></td>
