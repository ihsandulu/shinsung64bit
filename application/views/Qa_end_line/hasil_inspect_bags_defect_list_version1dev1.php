...
<style>
  ...
  .text-wrap {
    ...
    white-space: normal;   /* Mengizinkan pembungkusan baris */
}
.p-2{padding: 5px; font-size: 15px;}
</style>
    ...
    <div class="row">
      <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 colomn_satu">
        ...
        <div id="detail_data">
          ...
          <div align="left" class="isi font-besar"><b>#<?php echo $schedule['KANAAN_PO']; ?> / <?php echo $schedule['STYLE_NO']; ?> / <?php echo $schedule['COLOR']; ?> / <?php echo $schedule['SIZE']; ?> </b></div>
        ...
        <div class="row">
          <div class="col-md-12 mb-3"><span class="label label-danger p-2">Top 5 Defect</span></div>
          <?php
          ...
          foreach ($top5defects as $kode_defect => $keterangan) { ?>
            ...
            <div class="col-md-3 mb-3">
              <button class="btn btn-block btn-xs btn-danger" onclick="top5defect('001');"><span class="text-wrap"><?= $kode_defect; ?></span></button>
            </div>
          <?php }
          ?>
...
<script language="javascript">
  ...
  function btn_style() {
    location.href = "<?php echo base_url(); ?>Qa_end_line/daftar_schedule1/<?php echo $line; ?>";
  }
...
<script>
  ...
  function ok_defect() {
    if (cekid != "") {
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo base_url() . 'Qa_end_line/hasil_inspect_bags_defect_list_version1_action1/' . $line . '/' . $id_schedule  ?>",
        dataType: "JSON",
        data: {
