    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ?>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <table class="table table-striped table-bordered" id="Table_summary" style="width:100%;">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="23%" style="text-align:center;"> SUM DEFECT GARMENT: <font size="+1"><strong>
                                    <div>G:<span id="jml_defect<?= $no; ?>"></span> / D:<span id="jml_tdefect<?= $no; ?>"></span></div>
                                            </strong></font>
                                    </td>
                        ...
                        <script language="javascript">
                            ...
                            function call_sp_grid_summary_hasil_inspect_bags_defect_list_version1() {
                                // alert('<?=base_url();?>Qa_end_line/sp_grid_summary_hasil_inspect_bags_defect_list_versionb/<?=$line;?>?date1=<?=$tanggal;?>&KANAAN_PO=<?= $row->KANAAN_PO; ?>&STYLE_NO=<?= $row->STYLE_NO; ?>');
                                var table = document.getElementById("Table_summary");
                                $.ajax({
                                    type: 'POST',
                                    url: '<?=base_url();?>Qa_end_line/sp_grid_summary_hasil_inspect_bags_defect_list_versionb/<?=$line;?>?date1=<?=$tanggal;?>&KANAAN_PO=<?= $row->KANAAN_PO; ?>&STYLE_NO=<?= $row->STYLE_NO; ?>',
                                    dataType: "JSON",
                                    data: {
                                    },
                                    success: function(response) {
                                        ...
                                        document.getElementById("jml_tdefect<?= $no; ?>").innerHTML = response[0].total_defect;
                    ...
                    $this->db->where("CONVERT(VARCHAR(10), time_stamp, 120) = CONVERT(VARCHAR(10), '" . $tanggal . "', 120)");
