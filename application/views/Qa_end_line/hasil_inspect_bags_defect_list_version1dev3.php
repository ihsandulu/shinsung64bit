...
<div class="alert alert-warning" id="success-alert-final-ok">
  <button type="button" class="close" data-dismiss="alert">x</button>
  <strong> </strong> OUTPUT IRONING DITAMBAHKAN
</div>
</div>
...
<div class="alert alert-warning" id="success-alert-final-hd-ok">
  ...
  <div class="row">
    ...
    <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 colomn_dua">
      ...
      <div align="right">
      <font size="+1">OUTPUT IRONING : </font><b> <span id="jml_qty" style="text-align:left; font-weight: bold; margin-right:10px; font-size:18px;"></span></b>
...
function refresh_hasil_output_packing()
{
     $.ajax({
      type: 'POST',
      url: "<?php echo base_url().'Qa_end_line/json_hasil_output_ironing/' . $line .'/'.$id_schedule   ?>",
      dataType: "JSON",
      data: {
      },
      success: function(response) {
