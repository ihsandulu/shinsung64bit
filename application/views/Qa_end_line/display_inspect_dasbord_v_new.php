  ...
  <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
      ...
      <table class="table table-striped table-bordered" id="Table_summary" style="width:100%;">
        <tbody>
          <tr>
          	<td width="12%" style="text-align:center;"> LINE <font size="+1"><strong><div><?php echo $line; ?></div></strong></font></td>
            <td width="20%" style="text-align:center;"> OUTPUT : <font size="+1"><strong><div id="jml_qty"></div> </strong></font></td>
            <td width="22%" style="text-align:center;" hidden> QTY CHECK : <font size="+1"><strong><div id="jml_ceck"></div></strong></font></td>
            <td width="23%" style="text-align:center;"> DEFECT : <font size="+1"><strong><div id="jml_defect"></div> </strong></font></td>
            <td width="23%" style="text-align:center;"> OK : <font size="+1"><strong><div id="jml_ok"></div> </strong></font></td>
            <td width="23%" style="text-align:center;" id="button_statusX" hidden> % DEFECT : <font size="+1"><strong><div id="jml_persen"></div> </strong></font></td>
            <td width="23%" style="text-align:center;" id="button_status"> % DEFECT : <font size="+1"><strong><div id="jml_persen_new"></div> </strong></font></td>
          </tr>
        </tbody>
      </table>
...
function  call_sp_grid_summary_hasil_inspect_bags_defect_list_version1()
{
 ...
 //var cell = table.rows[1].cells[1];
  ...
  document.getElementById("jml_ok").innerHTML = response[0].total_qty - response[0].qty_defect;
  
	document.getElementById("jml_persen_new").innerHTML = Math.round((response[0].qty_defect / response[0].total_qty) * 100);
