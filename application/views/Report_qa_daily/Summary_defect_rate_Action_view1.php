            ...
            <table border="1" width="100%" id="tabel" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    foreach ($distinct_dates as $key => $value) {
                        ...
                        foreach ($daftar_line as $key => $d_line) {
                            ...
                            if ($dt_check && $dt_defect) {
                                ...
                                $dr = $q_defect / ($q_check+$q_defect) * 100;
                                $avgcount++;
                            } elseif ($dt_check) {
                                $q_check = $dt_check[0]['qty_check'];
                                $q_defect = 0;
                            ...
                            $avg += $dr;
                            $arr_sum[$line] += $dr;
                            echo " <td title=' defect : " . $q_defect . ' | Cek :' . $q_check  . "'> " . number_format($dr, 1, ",", ".")   . " % </td>";
                        }
                    ...
                    <tr style="background-color : lightgray;">
                        ...
                        if(count($distinct_dates)>0){
                            $cdistinct_dates=$g_avg / count($distinct_dates);
                        }else{
                            $cdistinct_dates=0;
                        }
                        echo " <td> " . number_format($cdistinct_dates, 1, ",", ".") . "%</td>";
                        ?>
                    </tr>
                </tbody>
            </table>
...
<script>
    $('#tabel').DataTable({
        ...
        buttons: [{
                ...
                title: 'Summary Defect Rate % Report'
            },
            {
                extend: 'print',
                text: 'Print',
