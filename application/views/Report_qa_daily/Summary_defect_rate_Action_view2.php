                ...
                <tbody>
                    ...
                    foreach ($distinct_dates as $key => $value) {
                        ...
                        foreach ($daftar_line as $key => $d_line) {
                            ...
                            $avg += $dr;
                            $arr_sum[$line] += $dr;
                            echo " <td title=' defect : " . $q_defect . " | Cek :" . $q_check  . "'> " . number_format($dr, 1, ".", ",")   . " % <br/><span style='color:red'>" . number_format($q_defect,0,".",",") . "</span> <br/><span style='color:green'>" . number_format($q_check,0,".",",")  . "</span></td>";
                        }
