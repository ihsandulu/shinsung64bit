...
<?php echo modal_start("detailKisModal", "Detail KIS", FALSE); ?>
<div id="detailKis"></div>
<?php echo modal_end(); ?>
...
<script>
  $(function() {
    ...
    $('#formReport').on('submit', function(e) {
      ...
      $.ajax({
        url: baseUrl + 'Report/ajaxCeisaXKis',
        type: 'POST',
        dataType: 'HTML',
  ...
  function detailKis(nomorDaftar, tanggalDaftar) {
    $.ajax({
      url: baseUrl + 'Report/detailKis',
      type: 'POST',
      dataType: 'HTML',
      data: {
    ...
    .done(function(response) {
      $('#detailKisModal').modal('show');
      $('#detailKis').html(response);
    });
