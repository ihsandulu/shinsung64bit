...
<script language="javascript">
  function btn_save() {
    ...
    // $("#test").text('<?php echo base_url() ?>Grafik/weekly_top_5_per_line?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '');
    // alert('<?php echo base_url() ?>Grafik/weekly_top_5_per_line?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '');
    $('#list_report').load('<?php echo base_url() ?>Grafik/weekly_top_5_per_line?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '', function(responseTxt, statusTxt, xhr) {
