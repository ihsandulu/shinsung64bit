...
Highcharts.chart('container', {
    ...
    title: {
        text: 'TOP 5 DEFECT PERLINE <BR> LINE <?php echo $infoline_sewing ?> WEEK : <?php echo $infoweek; ?> - BULAN : <?php echo strtoupper(angkaKeBulan($infobulan)).' '.$infotahun ?>'
    },
    subtitle: {
        text: '<br/>'
    },
    ...
    tooltip: {
        headerFormat: '<span style="font-size:14px"><u>Tanggal {point.key}</u></span><table>',
	...
	<?php foreach ($kode_defect as $rows): ?>
		{
			...
			data: [
				...
				<?php if($rows['kode_defect'] == $rows_['kode_defect']) { ?>
