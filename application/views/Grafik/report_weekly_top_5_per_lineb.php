  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-2">
      <div class="form-group">
        ...
        <input type="date" value="<?=date("Y-m-d");?>" class="form-control" id="tanggal_awal" name="tanggal_awal" autocomplete="off">
      </div>
    </div>
    <div class="col-md-2">
      <div class="form-group">
        <label for="tanggal_akhir">Tanggal Akhir</label>
        <input type="date" value="<?=date("Y-m-d");?>" class="form-control" id="tanggal_akhir" name="tanggal_akhir" autocomplete="off">
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
...
<script language="javascript">
  function btn_save() {
    ...
    // $("#test").text('<?php echo base_url() ?>Grafik/weekly_top_5_per_lineb?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '');
    // alert('<?php echo base_url() ?>Grafik/weekly_top_5_per_lineb?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '');
    $('#list_report').load('<?php echo base_url() ?>Grafik/weekly_top_5_per_lineb?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '', function(responseTxt, statusTxt, xhr) {
