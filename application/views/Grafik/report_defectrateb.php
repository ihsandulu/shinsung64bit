...
<script language="javascript">
    function btn_save() {
        ...
        $('#list_report').load('<?php echo base_url() ?>Grafik/defectrateb?buyer=' + encodedBuyer + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir + '&line=' + line + '', function(responseTxt, statusTxt, xhr) {
