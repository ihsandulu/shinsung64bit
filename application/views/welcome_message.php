<div class="row">
  ...
  <div id="detail_grafik_open">
    ...
    <!-- Top 5 Defect Rate Line Daily -->
    <div class="col-md-4 col-xs-12" style="border-right:0px solid #999; border-bottom:1px solid #999; border-right:1px solid #999;">
    ...
    <div class="col-md-4 col-xs-12" style="border-right:1px solid #999;  border-bottom:1px solid #999;">
      <div id="open_grafik_top5_defect"></div>
    </div>

    <script language="javascript">
      $('#open_grafik_top5_defect').load('<?php echo base_url() . 'Welcome/weekly_top_5_per_line' ?>');
    </script>
    <script language="javascript">
      $(document).ready(function() {
        setInterval(function() {
    ...
    <!-- <div class="col-md-4 col-xs-12" style="border-right:0px solid #999; border-bottom:1px solid #999;">
      <div id="open_grafik_avg_weekly"></div>
    </div>
    <script language="javascript">
      $('#open_grafik_avg_weekly').load('<?php echo base_url() . 'Home/avg_defect_weekly' ?>');
    </script> -->
    ...
    <!-- Top 5 Defect Rate Line Weekly -->
    <div class="col-md-4 col-xs-12" style="border-right:0px solid #999; border-bottom:1px solid #999; border-right:1px solid #999;">
      <div id="open_top_5w"></div>
    </div>
    <script language="javascript">
      $('#open_top_5w').load('<?php echo base_url() . 'Welcome/list_report_dasbord_top5w' ?>');
    </script>
    <script language="javascript">
      $(document).ready(function() {
        setInterval(function() {
    ...
    <!-- Top 5 Defect Weekly -->
    <div class="col-md-4 col-xs-12" style="border-right:1px solid #999;  border-bottom:1px solid #999;">
      <div id="open_grafik_top5_defectw"></div>
    </div>

    <script language="javascript">
      $('#open_grafik_top5_defectw').load('<?php echo base_url() . 'Welcome/weekly_top_5_per_linew' ?>');
    </script>
    <script language="javascript">
      $(document).ready(function() {
        setInterval(function() {
...
<!-- Defect Rate By Buyer Weekly -->
    ...
    <script language="javascript">
      $('#open_grafik_ppm').load('<?php echo base_url() . 'Home/monthly_order_status' ?>/<?php echo date('Y-m-d'); ?>/Y');
      $('#open_grafik_ppm2').load('<?php echo base_url() . 'Home/defect_rate_buyer_weekly' ?>/<?php echo date('Y-m-d'); ?>/Y');
