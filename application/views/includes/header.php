          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs"><?php //echo $user->first_name 
                                        ?> <?php echo $user->last_name; ?> </span> </a>
              <ul class="dropdown-menu">
                <!-- The user image in the menu -->
                <li class="user-header"> <span style="font-size: 60px;color: white;"><i class="fa fa-user-circle-o" aria-hidden="true"></i></span>
                  <p> <?php //echo $user->first_name 
                      ?> <?php echo $user->last_name; ?> <small><?php echo $user->company ?></small> </p>
                </li>
          ...
          ?>
            <li class="treeview"> <a href="#"><i class="fa fa-list-alt" aria-hidden="true"></i> <span> PRODUCTION </span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
              <ul class="treeview-menu">
                <li <?php echo ($slugName == 'Qa_end_line_dashboard') ? 'class="active"' : '' ?>><a href="<?php echo base_url('Qa_end_line_dashboard') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> LINE MONITORING</a></li>
                ...
                <li <?php echo ($slugName == 'Report_end_line/Report_summary_defect1') ? 'class="active"' : '' ?>><a href="<?php echo base_url('Schedule_produksi') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> PRODUCTION SCHEDULE</a></li>
              </ul>
            </li>
          <?php endif; ?>
          ...
          ?>
            ...
            <li class="treeview"> <a href="#"><i class="fa fa-list-alt" aria-hidden="true"></i> <span> QUALITY CONTROL </span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
              <ul class="treeview-menu">
                ...
                <li <?php echo ($slugName == 'Qa_end_line') ? 'class="active"' : '' ?>><a href="<?php echo base_url('Qa_end_line') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> INPUT DEFECT </a></li>
                <li <?php echo ($slugName == 'Report_end_line/Report_summary_defect2') ? 'class="active"' : '' ?>><a href="<?php echo base_url('Report_end_line/Report_summary_defect2') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> MONTHLY QTY </a></li>
                ...
                <li <?php echo ($slugName == 'Report_end_line/Report_summary_defect1') ? 'class="active"' : '' ?>><a href="<?php echo base_url('Report_end_line/Report_summary_defect1') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> DEFECT MONITORING</a></li>
              ...
              <li <?php echo ($slugName == 'grafik/report_monthly_top_5_per_line') ? 'class="active"' : '' ?>><a href="<?php echo base_url('grafik/report_monthly_top_5_per_line') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> TOP 5 MONTHLY </a></li>-->
                ...
                <li <?php echo ($slugName == 'Qa_end_line/weeklydefect') ? 'class="active"' : '' ?>><a href="<?php echo base_url('Qa_end_line/weeklydefect') ?>"><i class="fa fa-circle-o" aria-hidden="true"></i> WEEKLY DEFECT </a></li>
              </ul>
            </li>
          <?php endif; ?>
